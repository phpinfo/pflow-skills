---
name: pflow-bro
description: Re-explains the previous assistant message in a much simpler way — for when the reply made you go "bro what". Use /bro to get a plain-language version of the last answer.
license: MIT
---
