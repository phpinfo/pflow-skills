...
- **Language: the entire message (description, body, and footers) MUST always be written in English — never in any other language, regardless of the language used in the conversation or the source.**
